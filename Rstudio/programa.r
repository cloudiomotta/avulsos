#------------------------------------------------------------------------
  ...
  ######AULA PR�TICA MORTALIDADE E FECUNDIDADE######

#------------------------------------------------------------------------
# 1O: MUDAR O DIRET�RIO PARA A PASTA QUE TEM O SCRIPT E O BANCO DE DADOS
  
  
# 2O: BAIXAR A BIBLIOTECA QUE VAMOS TRABALHAR MAIS ADIANTE E CHAMAR A BIBLIOTECA
  
library(tidyverse)

#Lendo o banco de dados com informa��es de popula��o e �bito que recebeu o nome de "pop.csv"

aula <- read.csv("Rstudio/popu.csv", sep = ";", header = T) #getwd()
...
# Perguntar em cada passo como se calcula os respectivos indicadores
